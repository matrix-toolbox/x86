...
2021-02-17 export reduce24 as a header
        ...
        $ gcc -Werror -o ASCII_FMC ASCII_FMC.c -lm
	$ ./ASCII_FMC GIMP_RAW_DATA_FILE.data GIMP_RAW_DATA_FILE_c.data OUT.ASM
...
prepare_DB(unsigned char *DATA32, char* OUT_ASM)
{
    ...
    strcpy(sys_cmd, "cp ASCII_FMC.CORE ");
